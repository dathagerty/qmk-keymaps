...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    TAB_L1,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, MO(_L1),
  ...
  [_ST] = LAYOUT( /* STRNK */
    ...
    TAB_L1,  KC_S,    KC_T,    KC_R,    KC_N,    KC_K,    KC_Y,    KC_M,    KC_A,    KC_E,    KC_I,    MO(_L1),
    KC_LSFT, KC_Z,    KC_Q,    KC_X,    KC_H,    KC_P,    KC_W,    KC_C,    KC_QUOT, KC_SCLN, KC_DOT,  MO(_L2),
    KC_LCTL, MO(_L2), KC_LGUI,                   KC_SPC,  KC_ENT,                    KC_RALT, KC_ESC,  TG(_L3)
  ),
  [_CM] = LAYOUT( /* Colemak */
    KC_ESC,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSPC,
    TAB_L1,  KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    MO(_L1),
